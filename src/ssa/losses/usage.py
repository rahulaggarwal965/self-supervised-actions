...
class UsageLoss:
    ...
    def __call__(self, out, batch, model):
        ...
        p_bar = probs.mean(0)
        # TODO: when batch_size << num_codes, p_bar (this batch's mean assignment)
        # is a poor estimate of true codebook usage; consider an optional EMA of
        # p_bar across batches for a more stable estimate.
